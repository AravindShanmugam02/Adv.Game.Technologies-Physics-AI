...
namespace NCL {
	...
	public:
		...
		struct CollisionInfo {
			...
			ContactPoint GetCP() { return point; }
			void AddCP(const ContactPoint& contactPoint) { point = contactPoint; }
		...
		static bool AABBOBBIntersection(const AABBVolume& volumeA, const Transform& worldTransformA, const OBBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		//float capsuleIntersect(Vector3& rayOrigin, Vector3& rayDirection, Vector3& pointA, Vector3& pointB, float radius);
		static bool AABBCapsuleIntersection(const CapsuleVolume& volumeA, const Transform& worldTransformA, const AABBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
